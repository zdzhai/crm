...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveCreateActivityRemarkBtn").click(function () {
			...
			//*********************这里需要加上引号，否则js会解析为js变量，但由于没有定义，所以会导致报错
			//发送请求
			$.ajax({
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>市场活动-<b>${requestScope.activity.name}</b> <small>${requestScope.activity.startDate} ~ ${requestScope.activity.endDate}</small></h3>
		</div>
	...
	<div id="remarkDivList" style="position: relative; top: 10px; left: 40px;">
		...
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px; bottom: 10px;">
