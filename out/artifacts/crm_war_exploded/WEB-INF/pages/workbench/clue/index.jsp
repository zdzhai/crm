...
<script type="text/javascript">
	...
	$(function(){
		//用户点击创建按钮弹出创建市场活动的模态窗口
		$("#createClueBtn").click(function () {
			$("#creatClueForm")[0].reset();
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="creatClueForm" class="form-horizontal" role="form">
				...
				<div class="modal-footer">
					...
					<button type="button" id="saveClueBtn" class="btn btn-primary" data-dismiss="modal">保存</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/forClueDetail.do?id=3ca43b5d72354d4891afcca775390a66';">李茹星博士</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
